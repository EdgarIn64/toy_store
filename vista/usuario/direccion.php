...
//		require('../../controlador/comprobar_sesion.php');
	...
	<form method="post" action="">
		<table>
			...
			<tr>
				<td>CP</td>
				<td id=cp><input type="txt" name="cp" value="<?php //echo $_SESSION['datos'][0][10];?>"></td>
			</tr>
			<tr>
				<td>Ciudad</td>
			...
			<tr>
				<td>Tel_celular</td>
				<td id="tel_celular"><input type="txt" name="tel_celular" value="<?php //echo $_SESSION['datos'][0][13];?>"></td>
			</tr>
			<tr>
				<td>Tel_extra</td>
				<td id="tel_extra"><input type="txt" name="tel_extra" value="<?php //echo $_SESSION['datos'][0][14];?>"></td>
			</tr>
		</table>
		<br><br>
